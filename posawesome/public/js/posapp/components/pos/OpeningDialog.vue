      ...
      <v-card>
        <v-card-title>
          <span class="headline primary--text">{{
            __('Please open your shift first.')
          }}
          <a style="color: burlywood !important;font-size: medium !important;" 
            onclick="window.open ('../app/pos-opening-shift', ''); return false" href="javascript:void(0);">Click here</a>
          </span>
        </v-card-title>
        <!-- <v-card-text>
          <v-container>
